...
function(_Eggs_SD6_AddFeatureTest feature output output_provided) # <value> <variable> <variable>
  ...
  foreach(feature_test ${feature_tests})
    ...
    if(feature_test_ext MATCHES "\\.([0123456789]+)\\.?(.*)\\.cpp")
      set(feature_test_value ${CMAKE_MATCH_1})
      string(REPLACE "." ";" feature_test_includes "${CMAKE_MATCH_2}")
    else()
      message(FATAL_ERROR "Eggs.SD-6 invalid test detected")
    endif()
